...
function FeaturesSection() {
  return (
    <section className="relative py-5 bg-white">
      ...
      <div className=" max-w-4xl mx-auto px-5 py-5 md:py-10 pb-10 md:pb-36 mt-16">
        <div className="text-center">
          <h2 className="font-semibold text-3xl text-[var(--themeColor2)]">
            Features of MediCare+
          </h2>
          <p className="max-w-md mx-auto mt-2 text-gray-500">
            An all-in-one healthcare platform designed to simplify medical
            consultations, record management, and seamless payments.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-10 mt-10">
          <div className="flex gap-4 items-start">
            <span className="text-[var(--themeColor2)] bg-white p-3 rounded-full">
              <svg
                width={15}
                height={15}
                viewBox="0 0 15 15"
            ...
            <div>
              <h3 className="font-semibold text-xl text-[var(--themeColor)]">
                Effortless Appointment Management
              </h3>
              <p className="mt-1 text-gray-500">
                {" "}
                Book, reschedule, or cancel appointments with real-time
                availability and automated reminders to avoid missed visits
              </p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-500">
                ...
                prescriptions, and test reports for better healthcare
                coordination.
              </p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-[var(--themeColor)]">
                Seamless E-Prescriptions & Pharmacy Services
              </h3>
              <p className="mt-1 text-gray-500">
                Receive digital prescriptions from doctors and order medicines
                online with fast delivery and automated refill reminders.
              </p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-[var(--themeColor)]">
                Intelligent Doctor & Hospital Search
              </h3>
              <p className="mt-1 text-gray-500">
                {" "}
                Find top-rated doctors, clinics, and hospitals based on
                specialization, location, and verified patient reviews.
              </p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-500">
                Pay medical bills effortlessly using multiple payment options,
                with seamless health insurance claim processing.
              </p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-500">
                HIPAA-compliant encryption and access controls ensure complete
