            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-6 lg:max-w-sm">
                <p className="text-sm text-gray-800 text-justify">
                  ...
                  management, secure medical records, and smart insights.
                  Designed for efficiency, MediCare+ ensures a smoother
                  experience for patients and healthcare providers alike
                </p>
                <p className="mt-4 text-sm text-gray-800">
                  Experience the future of digital healthcare with MediCare+.
                  Stay connected, stay informed, and take control of your
