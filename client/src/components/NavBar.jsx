...
function NavBar() {
  ...
  return (
    <header>
      ...
      <nav className="bg-white py-6 shadow-xl shadow-gray-200/10 border-gray-100 border-b">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
          <a href="#" className="flex items-center">
            <span className="self-center text-[var(--themeColor2)] text-xl hover:text-[var(--themeColor)] font-semibold whitespace-nowrap">
              MediCare+
            </span>
          </a>
