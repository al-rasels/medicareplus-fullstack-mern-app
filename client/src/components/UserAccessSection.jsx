...
function UserAccessSection() {
  return (
    <section className="relative text-gray-900 flex justify-center py-16 md:py-26 px-4">
      {/* Background */}
      <div className="absolute inset-y-0 top-0 -z-10 w-full overflow-hidden bg-gray-200 ring-1 ring-gray-900/10">
        <svg
      ...
      <div className="max-w-screen-xl m-0 sm:m-10 bg-white/50  sm:rounded-lg flex flex-col md:flex-row w-full">
        {/* Login Section */}
        <div className="w-full md:w-1/2 px-6 py-8 sm:px-10">
          <LoginSection />
        </div>
        ...
        {/* Register Section */}
        <div className="w-full md:w-1/2 px-6 py-6 sm:px-10">
          <RegisterSection />
        </div>
      </div>
    </section>
