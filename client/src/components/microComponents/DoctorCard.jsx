          ...
          <div className="px-2 py-2">
            ...
            <div className="flex my-3 flex-wrap space-x-3 justify-center items-center">
              ...
              <Link to={`/doctors-detail/${item?.["_id"]}`}>
                <button className="bg-[var(--themeColor2)] text-white py-2 px-4 rounded-full font-semibold hover:bg-[var(--themeColor)] transition-colors duration-300 cursor-pointer">
                  Visit Now
                </button>
              </Link>
            </div>
